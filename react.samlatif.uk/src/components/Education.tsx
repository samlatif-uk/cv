    ...
    <div className="container">
      ...
      <div className="edugrid">
        <div className="educard">
          ...
          <div className="edunote">Final project deferred to maintain quality of concurrent client commitments.</div>
        </div>
        <div className="educard">
          ...
          <div className="edunote">Modules: Games Programming, 3D Graphics, Virtual Environments, Network Gaming, Advanced Animation, Project Management.</div>
        </div>
        <div className="educard">
          <div className="edudeg">
            BSc Cognitive Science <span style={{ fontSize: '12px', fontWeight: 400, fontStyle: 'italic' }}>(1st year attended)</span>
          </div>
          ...
          <div className="edunote">
            Foundations in HCI, UX design, human behaviour and logic — directly relevant to frontend and UX work. Transferred to pursue a CS-focused degree.
          </div>
        </div>
      </div>
    </div>
