...
export const GLOBAL_STACK_DEFAULTS = ['HTML5', 'CSS3 / SCSS / LESS', 'Git'];
...
export const JOBS: Job[] = [
  ...
  },
  {
    ...
    stack: ['React 15/16', 'TypeScript', 'GraphQL', 'Redux', 'Redux-Form', 'SCSS', 'Webpack', 'Babel', 'React Testing Library', 'Enzyme', 'Mocha'],
  },
  {
    co: 'RehabStudio',
    date: 'Jan – Feb 2018',
    ...
    bullets: ['Built startupgarage.fb.com in 10 days — both English and French versions, fully responsive'],
    stack: ['WordPress', 'HTML', 'jQuery', 'SCSS', 'Rollup', 'Bootstrap 3'],
  },
  {
    co: 'Goldman Sachs',
    date: 'Jan – Oct 2017',
  ...
  },
  {
    ...
    stack: ['React Native', 'React 0.15', 'Redux', 'Babel', 'Webpack', 'SASS', 'PostCSS', 'jQuery', 'Azure/.NET'],
  },
  {
    ...
    bullets: [],
    stack: ['React 0.13/14', 'Redux', 'Node.js', 'Webpack', 'Babel', 'React Router'],
  },
  {
  ...
  },
  {
    ...
    bullets: [],
    stack: ['Axure', 'Balsamiq', 'Sketch', 'InVision'],
  },
  {
    co: 'CACI / Chelsea FC',
    date: 'Oct – Dec 2014',
    ...
    stack: ['HTML5', 'CSS', 'jQuery', 'Adobe CQ5', 'Java Spring MVC', 'Gigya'],
  },
  {
    co: 'We3Collective',
    date: 'Sep – Nov 2014',
  ...
  },
  {
    ...
    stack: ['HTML5', 'SCSS', 'jQuery', 'Umbraco'],
  },
  {
    co: 'RehabStudio',
    date: 'Aug 2014',
  ...
  },
  {
    ...
    stack: ['Ruby on Rails', 'HAML', 'SCSS', 'CoffeeScript', 'jQuery', 'D3.js'],
  },
  {
  ...
  },
  {
    ...
    stack: ['Magento', 'PHP', 'MySQL', 'HTML5', 'CSS', 'jQuery', 'Google Maps API'],
  },
  {
    co: 'Grabble Ltd',
    date: 'Jul – Nov 2013',
    ...
    stack: ['PHP (Zend)', 'Bootstrap', 'HTML5', 'CSS3', 'jQuery'],
  },
  {
  ...
  },
  {
    ...
    bullets: [],
    stack: ['PHP', 'Symfony2', 'HAML', 'SCSS', 'jQuery', 'Highcharts'],
  },
  {
    ...
    bullets: ['Communicated technical concepts to a diverse group in an accessible, clear manner'],
    stack: [],
  },
];
