...
export const TECH_ROWS: TechRow[] = [
  {
    cat: "Front End",
    items: "HTML5, CSS / SCSS / SASS / LESS, JS (OOP, Functional, FRP)",
    yrs: "15+",
  },
  { cat: "Design Tools", items: "Photoshop, Sketch, Figma", yrs: "15+" },
  {
    cat: "JS Frameworks",
    items: "React, React Native, Redux, TypeScript, Next.js",
    yrs: "13+",
  },
  {
    cat: "Testing",
    items:
      "React Testing Library, Cypress, Jest, Enzyme, Mocha, Karma, Istanbul",
    yrs: "13+",
  },
  {
    cat: "Wireframing",
  ...
  {
    cat: "State Mgmt",
    items: "Redux, Redux Toolkit, Context API, Zustand, React Query, TRPC",
    yrs: "12+",
  },
  {
    cat: "Backend / DB",
    items: "Node.js, MongoDB, MySQL, PHP, GraphQL",
    yrs: "11+",
  },
  {
    cat: "Visualisation",
    items: "D3.js, Three.js, Highcharts, Canvas (FabricJS, PixiJS)",
    yrs: "10+",
  },
];
...
export const SKILLS: Skill[] = [
  { n: "React", c: "core" },
  { n: "React Native", c: "core" },
  { n: "TypeScript", c: "core" },
  { n: "JavaScript (ES6+)", c: "core" },
  { n: "JavaScript (ES5)", c: "core" },
  { n: "HTML5", c: "core" },
  { n: "CSS3 / SCSS / LESS", c: "core" },
  { n: "Next.js", c: "core" },
  { n: "Node.js", c: "core" },
  { n: "GraphQL", c: "core" },
  { n: "RESTful APIs", c: "core" },
  { n: "Redux", c: "state" },
  { n: "Redux Toolkit", c: "state" },
  { n: "React Query", c: "state" },
  { n: "TRPC", c: "state" },
  { n: "Zustand", c: "state" },
  { n: "Context API", c: "state" },
  { n: "Jest", c: "testing" },
